...
urlpatterns = [
    ...
    path(r'^respuesta/nuevo/(?P<pk>\d+)/$', views.crear_respuestas.as_view(), name='respuesta_n'),
    url(r'^respuesta/editar(?P<pk>\d+)/$',views.editar_respuestas.as_view(), name='respuesta_e'),
